...
const leads = [
  ...
  {company:'Centro Clínico de Odivelas',sector:'Clínica Dentária',location:'Odivelas',website:'https://centroclinicoodivelas.pt/',phone:'+351 219 329 135',email:'geral@centroclinicoodivelas.pt',source:'https://fadadodente.pt/clinica/centro-clinico-de-odivelas-clinica-dentaria-odivelas',opportunity:'implantologia, ortodontia, estética dentária e prevenção permitem conteúdos educativos e visuais que reforçam confiança e ajudam a gerar marcações',idea:'Sorrisos + tratamentos explicados + equipa + prevenção + FAQ',priority:'atacar',plan:'intermedio',monthly:200,offer:100},
