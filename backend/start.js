...
try {
  ...
  if (!ph.includes('/js/prospect-template-public.js')) ph = ph.replace('</body>', '<script src="/js/prospect-template-public.js?v=20260922lp5"></script>\n</body>');
  else ph = ph.replace(/prospect-template-public\.js\?v=[^'\"]+/g,'prospect-template-public.js?v=20260922lp5');
