...
try {
  ...
  else { ah = ah.replace(/proposal-templates-admin\.js\?v=[^'\"]+/g,'proposal-templates-admin.js?v=20260924c').replace(/duit-start-admin\.js\?v=[^'\"]+/g,'duit-start-admin.js?v=20260924c'); if(!ah.includes('/js/landing-pages-admin.js')) ah=ah.replace('</body>','<script src="/js/landing-pages-admin.js?v=20260925a"></script>\n</body>'); else ah=ah.replace(/landing-pages-admin\.js\?v=[^'\"]+/g,'landing-pages-admin.js?v=20260925a'); }
