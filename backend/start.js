...
try {
  ...
  if (!ah.includes('/js/proposal-templates-admin.js')) ah = ah.replace('</body>', '<script src="/js/proposal-templates-admin.js?v=20260918n"></script>\n<script src="/js/duit-start-admin.js?v=20260922f"></script>\n<script src="/js/landing-pages-admin.js?v=20260922c"></script>\n</body>');
  else { ah = ah.replace(/proposal-templates-admin\.js\?v=[^'\"]+/g,'proposal-templates-admin.js?v=20260918n').replace(/duit-start-admin\.js\?v=[^'\"]+/g,'duit-start-admin.js?v=20260922f'); if(!ah.includes('/js/landing-pages-admin.js')) ah=ah.replace('</body>','<script src="/js/landing-pages-admin.js?v=20260922c"></script>\n</body>'); else ah=ah.replace(/landing-pages-admin\.js\?v=[^'\"]+/g,'landing-pages-admin.js?v=20260922c'); }
