...
try {
  ...
  if (!ah.includes('/js/proposal-templates-admin.js')) ah = ah.replace('</body>', '<script src="/js/proposal-templates-admin.js?v=20260918n"></script>\n<script src="/js/duit-start-admin.js?v=20260918r"></script>\n</body>');
  else ah = ah.replace(/proposal-templates-admin\.js\?v=[^'\"]+/g,'proposal-templates-admin.js?v=20260918n').replace(/duit-start-admin\.js\?v=[^'\"]+/g,'duit-start-admin.js?v=20260918r');
  ...
  if (!ph.includes('/js/prospect-template-public.js')) ph = ph.replace('</body>', '<script src="/js/prospect-template-public.js?v=20260918s"></script>\n</body>');
  else ph = ph.replace(/prospect-template-public\.js\?v=[^'\"]+/g,'prospect-template-public.js?v=20260918s');
